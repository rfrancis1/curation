...
post_deid_dataset = "R2020q4r2_deid_clean"
pre_deid_dataset = "2020q4r1_combined"

from code.controlled_tier_qc import run_qc, display_check_summary_by_rule, display_check_detail_of_rule

to_include = ['DC-1370', 'DC-1377', 'DC-1346', 'DC-1348', 'DC-1355', 'DC-1357', 'DC-1359', 'DC-1362',
             'DC-1364', 'DC-1366', 'DC-1368', 'DC-1373', 'DC-1382']

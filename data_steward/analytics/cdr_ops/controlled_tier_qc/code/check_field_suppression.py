...
def check_field_suppression(project_id, post_dataset_id, rule_code, pre_deid_dataset=None):
...
def check_vehicle_accident_suppression(project_id, post_deid_dataset, rule_code, pre_deid_dataset=None):
    check_df = load_check_file(FIELD_CSV_FILE, rule_code)
...
def check_cancer_concept_suppression(project_id, post_deid_dataset, rule_code, pre_deid_dataset=None):
    check_df = load_check_file(FIELD_CSV_FILE, rule_code)
